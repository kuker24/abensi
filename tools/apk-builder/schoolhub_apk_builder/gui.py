...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("SIAB2 APK Builder — Mode Mudah")
    ...
    def _build_step_connect_web(self):
        page = QWidget(); layout = QVBoxLayout(page)
        layout.addWidget(help_box(
            "Langkah 2 — Hubungkan APK ke web SIAB2. Isi alamat web yang biasa dibuka admin/operator, "
        ...
        form.addRow("Alamat Web SIAB2", self.server)
    ...
    def _build_step_publish_web(self):
        ...
        self.release_notes = QPlainTextEdit("APK Android SIAB2 Reader."); self.release_notes.setMaximumHeight(100)
    ...
    def check_server(self):
        ...
        self.set_status("Web SIAB2 siap dipakai APK." if result.ok else "Web belum siap/URL salah. Cek pesan di Langkah 2.", "ok" if result.ok else "bad")
