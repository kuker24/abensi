...
- Card display resolves student class or staff role level from official export fields; student identity prefers NIS/NISN and staff identity prefers NIP. Keep printed labels and official QR payload handling synchronized with API export contract.
...
- Imported school data and exports may contain personal information. Avoid logging raw rows or committing generated card/export files.
