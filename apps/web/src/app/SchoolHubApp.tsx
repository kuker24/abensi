...
export const ROUTES = [
  ...
  { path: '/admin/sessions', area: 'Admin/TU', title: 'Sesi Hari Ini', roles: ['ADMIN_TU', 'OPERATOR_IT', 'GURU_PIKET', 'DEVELOPER'], capabilities: ['classAttendance.read'], render: ({ user }) => <SessionsPage admin={user.role !== 'GURU_PIKET'} /> },
