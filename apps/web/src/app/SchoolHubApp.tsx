...
const EarlyCheckoutEmergencyPage = lazyPage(loadAdminPages, 'EarlyCheckoutEmergencyPage');
...
const PersonnelLeaveReviewPage = lazyPage(loadAdminPages, 'PersonnelLeaveReviewPage');
...
const PersonnelLeavePage = lazyPage(loadGuruPages, 'PersonnelLeavePage');
...
export const ROUTES = [
  ...
  { path: '/admin/early-checkout-emergency', area: 'Kepala Sekolah', title: 'Mode Pulang Cepat', roles: ['KEPALA_SEKOLAH'], capabilities: ['earlyCheckoutEmergency.manage'], render: ({ notify }) => <EarlyCheckoutEmergencyPage notify={notify} /> },
  ...
  { path: '/admin/sessions', area: 'Admin/TU', title: 'Sesi Hari Ini', roles: ['ADMIN_TU', 'GURU_PIKET', 'DEVELOPER'], capabilities: ['classAttendance.read'], render: ({ user, notify }) => <SessionsPage admin={user.role !== 'GURU_PIKET'} notify={notify} /> },
  ...
  { path: '/admin/anomaly', area: 'Admin/TU', title: 'Masalah yang Perlu Dicek', roles: ['ADMIN_TU', 'GURU_PIKET', 'DEVELOPER'], capabilities: ['reconciliation.read'], render: ({ notify }) => <AnomalyPage notify={notify} /> },
  { path: '/admin/picket', area: 'Admin/TU', title: 'Catatan Piket', roles: ['ADMIN_TU', 'GURU_PIKET', 'DEVELOPER'], capabilities: ['reconciliation.read'], render: ({ notify }) => <PicketBookPage notify={notify} /> },
  { path: '/admin/master-data', area: 'Admin/TU', title: 'Akun & Data Sekolah', roles: ['ADMIN_TU', 'DEVELOPER'], capabilities: ['users.read', 'academic.read'], render: ({ notify }) => <MasterDataPage notify={notify} /> },
  ...
  { path: '/admin/schedule', area: 'Admin/TU', title: 'Jadwal Kelas', roles: ['ADMIN_TU', 'DEVELOPER'], capabilities: ['schedules.read'], render: ({ notify }) => <SchedulePage notify={notify} /> },
