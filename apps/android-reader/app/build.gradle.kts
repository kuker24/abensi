...
val versionNameProp = (project.findProperty("SCHOOLHUB_VERSION_NAME") as String?) ?: "1.2.9"
val versionCodeProp = ((project.findProperty("SCHOOLHUB_VERSION_CODE") as String?) ?: "13").toInt()
