...
val versionNameProp = (project.findProperty("SCHOOLHUB_VERSION_NAME") as String?) ?: "1.3.1"
val versionCodeProp = ((project.findProperty("SCHOOLHUB_VERSION_CODE") as String?) ?: "12").toInt()
