...
describe('ReportingController role/capability contract', () => {
  ...
  it.each([
    ...
    [Role.OPERATOR_IT, 'studentMonthlyAttendance', 403],
    [Role.KEPALA_SEKOLAH, 'studentMonthlyAttendance', 200],
    [Role.ADMIN_TU, 'staffMonthlyAttendance', 200],
    [Role.SISWA, 'staffMonthlyAttendance', 403],
