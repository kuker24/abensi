...
export const REPORT_TYPE_TITLES: Record<string, string> = {
  ...
  student_monthly_attendance: 'Rekap Bulanan Kehadiran Siswa',
  staff_monthly_attendance: 'Rekap Bulanan Kepala/Staf',
...
export const REPORT_COLUMN_LABELS: Record<string, string> = {
  ...
  assessed_day_count: 'Hari Dinilai',
  complete_day_count: 'Hari Lengkap',
  completion_percent: 'Kelengkapan (%)',
  missing_arrival_day_count: 'Hari Belum Scan Datang',
  missing_departure_day_count: 'Hari Belum Scan Pulang',
  missing_class_attendance_day_count: 'Hari Belum Absen Kelas',
  missing_prayer_day_count: 'Hari Belum Scan Sholat',
  needs_verification_day_count: 'Hari Perlu Verifikasi',
  gate_arrival_day_count: 'Hari Scan Datang',
  gate_departure_day_count: 'Hari Scan Pulang',
  required_prayer_count: 'Sholat Wajib',
  completed_prayer_count: 'Sholat Tercatat',
  defaulted_attendance_count: 'Presensi Belum Dikonfirmasi',
  scanned_day_count: 'Hari Ada Scan',
  arrival_day_count: 'Hari Scan Datang',
  departure_day_count: 'Hari Scan Pulang',
  first_scan_at: 'Scan Pertama',
  last_scan_at: 'Scan Terakhir',
